...
class CorrBlock3:
    def __init__(self, fmap1, fmap2, region1, region2, region3, region4, region5, region6, region7, region8,num_levels=4, radius=4,dataset='kitti'):
        ...
        if self.dataset == 'kitti':
            corr = CorrBlock3.corr3_k(fmap1, fmap2, region1, region2, region3, region4, region5, region6, region7, region8)
        else:
            corr = CorrBlock3.corr3_s(fmap1, fmap2, region1, region2, region3, region4, region5, region6, region7, region8)
    ...
    @staticmethod
    def corr3_k(fmap1, fmap2, region1, region2, region3, region4, region5, region6, region7, region8):
    ...
    @staticmethod
    def corr3_s(fmap1, fmap2, region1, region2, region3, region4, region5, region6, region7, region8):
        batch, dim, ht, wd = fmap1.shape
        fmap1 = fmap1.view(batch, dim, ht * wd).to(device)
